...
- The `ant.hook` package is a new setup hook for the Ant build system.
  See the [Ant section in the nixpkgs manual](https://nixos.org/manual/nixpkgs/unstable/#ant)
  for more information.
