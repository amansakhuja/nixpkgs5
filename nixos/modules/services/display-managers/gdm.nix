  ...
  config = lib.mkIf cfg.enable {
    ...
    security.pam.services = {
      gdm-launch-environment.text = ''
        auth     required       ${config.security.pam.package}/lib/security/pam_succeed_if.so audit quiet_success user = gdm
        auth     optional       ${config.security.pam.package}/lib/security/pam_permit.so

        account  required       ${config.security.pam.package}/lib/security/pam_succeed_if.so audit quiet_success user = gdm
        ...
        session  required       ${config.security.pam.package}/lib/security/pam_succeed_if.so audit quiet_success user = gdm
