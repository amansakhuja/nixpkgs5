...

{
  ...
  */
  ...
  blackhole-2ch = blackhole.override {
    audioChannel = "2ch";
  };

  blackhole-16ch = blackhole.override {
    audioChannel = "16ch";
  };

  blackhole-64ch = blackhole.override {
    audioChannel = "64ch";
  };

  blackhole-128ch = blackhole.override {
    audioChannel = "128ch";
  };

  blackhole-256ch = blackhole;
